        ...
        if (sell.state === 'Pago realizado') {
            ...
            async function main() {
                ...
                await transporter.sendMail({
                    ...
                    to: sell.email,
                    subject: `¡${sell.firstName} Tu compra ha ha sido generada y pagada con exito!`,
                    ...
                    <div style="margin: auto; width: 600px;">
                        ...
                        <div style="border-bottom: 1px solid #caccd6; padding-bottom: 30px;">
                            ...
                            <p style="text-align: center; font-family: poppins, sans-serif; color: #000000; font-size: 16px; font-weight: 300;">¡Hola ${sell.firstName}! Te queriamos comentar que tu compra ya ha sido generada y pagada con exito, cualquier actualización de tu pedido sera informado por este medio.</p>
