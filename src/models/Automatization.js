...
const AutomatizationSchema = new mongoose.Schema({
    ...
    automatization: [{ affair: { type: String, required: true }, title: { type: String, required: true }, paragraph: { type: String, required: true }, buttonText: { type: String }, url: { type: String }, date: { type: Date } }]
}, {
    timestamps: true
})
